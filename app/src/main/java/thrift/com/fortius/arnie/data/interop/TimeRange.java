...
public class TimeRange implements org.apache.thrift.TBase<TimeRange, TimeRange._Fields>, java.io.Serializable, Cloneable, Comparable<TimeRange>, android.os.Parcelable {
  ...
  public TimeRange(android.os.Parcel in) {
    //primitive bitfield of type: byte
  ...
  public static final android.os.Parcelable.Creator<TimeRange> CREATOR = new android.os.Parcelable.Creator<TimeRange>() {
    @Override
    ...
    @Override
    public TimeRange createFromParcel(android.os.Parcel in) {
  ...
  public TimeRange setStartTimestamp(long startTimestamp) {
    this.startTimestamp = startTimestamp;
    setStartTimestampIsSet(true);
    return this;
  }
  ...
  public TimeRange setEndTimestamp(long endTimestamp) {
    this.endTimestamp = endTimestamp;
    setEndTimestampIsSet(true);
    return this;
  }
