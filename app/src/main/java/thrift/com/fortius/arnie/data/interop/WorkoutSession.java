            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sets = new ArrayList<ExerciseSet>(_list8.size);
                ExerciseSet _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new ExerciseSet();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, WorkoutSession struct) throws org.apache.thrift.TException {
      ...
      if (struct.sets != null) {
        oprot.writeFieldBegin(SETS_FIELD_DESC);
        {
          ...
          for (ExerciseSet _iter11 : struct.sets)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetSets()) {
        {
          ...
          for (ExerciseSet _iter12 : struct.sets)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.sets = new ArrayList<ExerciseSet>(_list13.size);
          ExerciseSet _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new ExerciseSet();
            _elem14.read(iprot);
            struct.sets.add(_elem14);
          }
        }
        struct.setSetsIsSet(true);
      }
