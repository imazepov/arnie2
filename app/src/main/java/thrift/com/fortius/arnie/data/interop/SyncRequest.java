            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.existingSessionRanges = new ArrayList<TimeRange>(_list16.size);
                TimeRange _elem17;
                for (int _i18 = 0; _i18 < _list16.size; ++_i18)
                {
                  _elem17 = new TimeRange();
                  _elem17.read(iprot);
                  struct.existingSessionRanges.add(_elem17);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.newSessions = new ArrayList<WorkoutSession>(_list19.size);
                WorkoutSession _elem20;
                for (int _i21 = 0; _i21 < _list19.size; ++_i21)
                {
                  _elem20 = new WorkoutSession();
                  _elem20.read(iprot);
                  struct.newSessions.add(_elem20);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.existingSessionRanges != null) {
        if (struct.isSetExistingSessionRanges()) {
          oprot.writeFieldBegin(EXISTING_SESSION_RANGES_FIELD_DESC);
          {
            ...
            for (TimeRange _iter22 : struct.existingSessionRanges)
            {
              _iter22.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.newSessions != null) {
        if (struct.isSetNewSessions()) {
          oprot.writeFieldBegin(NEW_SESSIONS_FIELD_DESC);
          {
            ...
            for (WorkoutSession _iter23 : struct.newSessions)
            {
              _iter23.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetExistingSessionRanges()) {
        {
          ...
          for (TimeRange _iter24 : struct.existingSessionRanges)
          {
            _iter24.write(oprot);
          }
        }
      ...
      if (struct.isSetNewSessions()) {
        {
          ...
          for (WorkoutSession _iter25 : struct.newSessions)
          {
            _iter25.write(oprot);
          }
        }
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.existingSessionRanges = new ArrayList<TimeRange>(_list26.size);
          TimeRange _elem27;
          for (int _i28 = 0; _i28 < _list26.size; ++_i28)
          {
            _elem27 = new TimeRange();
            _elem27.read(iprot);
            struct.existingSessionRanges.add(_elem27);
          }
        }
        struct.setExistingSessionRangesIsSet(true);
      }
      if (incoming.get(3)) {
        {
          ...
          struct.newSessions = new ArrayList<WorkoutSession>(_list29.size);
          WorkoutSession _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new WorkoutSession();
            _elem30.read(iprot);
            struct.newSessions.add(_elem30);
          }
        }
        struct.setNewSessionsIsSet(true);
      }
