            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.missingSessionRanges = new ArrayList<TimeRange>(_list24.size);
                TimeRange _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new TimeRange();
                  _elem25.read(iprot);
                  struct.missingSessionRanges.add(_elem25);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.missingSessions = new ArrayList<WorkoutSession>(_list27.size);
                WorkoutSession _elem28;
                for (int _i29 = 0; _i29 < _list27.size; ++_i29)
                {
                  _elem28 = new WorkoutSession();
                  _elem28.read(iprot);
                  struct.missingSessions.add(_elem28);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.missingExercises = new ArrayList<Exercise>(_list30.size);
                Exercise _elem31;
                for (int _i32 = 0; _i32 < _list30.size; ++_i32)
                {
                  _elem31 = new Exercise();
                  _elem31.read(iprot);
                  struct.missingExercises.add(_elem31);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.missingSessionRanges != null) {
        if (struct.isSetMissingSessionRanges()) {
          oprot.writeFieldBegin(MISSING_SESSION_RANGES_FIELD_DESC);
          {
            ...
            for (TimeRange _iter33 : struct.missingSessionRanges)
            {
              _iter33.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.missingSessions != null) {
        if (struct.isSetMissingSessions()) {
          oprot.writeFieldBegin(MISSING_SESSIONS_FIELD_DESC);
          {
            ...
            for (WorkoutSession _iter34 : struct.missingSessions)
            {
              _iter34.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.missingExercises != null) {
        if (struct.isSetMissingExercises()) {
          oprot.writeFieldBegin(MISSING_EXERCISES_FIELD_DESC);
          {
            ...
            for (Exercise _iter35 : struct.missingExercises)
            {
              _iter35.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetMissingSessionRanges()) {
        {
          ...
          for (TimeRange _iter36 : struct.missingSessionRanges)
          {
            _iter36.write(oprot);
          }
        }
      ...
      if (struct.isSetMissingSessions()) {
        {
          ...
          for (WorkoutSession _iter37 : struct.missingSessions)
          {
            _iter37.write(oprot);
          }
        }
      ...
      if (struct.isSetMissingExercises()) {
        {
          ...
          for (Exercise _iter38 : struct.missingExercises)
          {
            _iter38.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.missingSessionRanges = new ArrayList<TimeRange>(_list39.size);
          TimeRange _elem40;
          for (int _i41 = 0; _i41 < _list39.size; ++_i41)
          {
            _elem40 = new TimeRange();
            _elem40.read(iprot);
            struct.missingSessionRanges.add(_elem40);
          }
        }
        struct.setMissingSessionRangesIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.missingSessions = new ArrayList<WorkoutSession>(_list42.size);
          WorkoutSession _elem43;
          for (int _i44 = 0; _i44 < _list42.size; ++_i44)
          {
            _elem43 = new WorkoutSession();
            _elem43.read(iprot);
            struct.missingSessions.add(_elem43);
          }
        }
        struct.setMissingSessionsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.missingExercises = new ArrayList<Exercise>(_list45.size);
          Exercise _elem46;
          for (int _i47 = 0; _i47 < _list45.size; ++_i47)
          {
            _elem46 = new Exercise();
            _elem46.read(iprot);
            struct.missingExercises.add(_elem46);
          }
        }
        struct.setMissingExercisesIsSet(true);
      }
